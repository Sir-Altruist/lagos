...
const Admin = () => {
  ...
  //     const updatedList = activeFilter.filter(
  ...
  //   const newNames = selected?.includes(id)
  //     ? selected?.filter((name) => name !== id)
  //     : [...(selected ?? []), { id }];
              ...
              {(rowsPerPage > 0
                ...
                .filter((item) => {
                  if (q === "") {
                    ...
                    item.invoice.toLowerCase().includes(q.toLowerCase())
                  ) {
                    return item;
                  } else {
                    return null;
                ...
                .map((single, i) => {
                  ...
                  const isItemSelected = isSelected(single._id);
                  return (
                    <StyledTableRow
                      // key={i}
                      // hover
                      onClick={(e) => handleClick(single._id)}
                      role="checkbox"
                    ...
                    >
                      ...
                      <StyledTableCell
                        ...
                        style={{ textAlign: "center" }}
                      >
                        {moment(single.createdAt).format("DD/MM/YYYY")}
                      </StyledTableCell>
                      <StyledTableCell
                        align="right"
                        style={{ textAlign: "center" }}
