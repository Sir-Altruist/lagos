...
// import BeceFilled from './BeceFilled';
...
const Bece = () => {
  ...
  return (
      <div className="main-bebe-container">
        <Box component='div' className='bece-update'>
            <Container>
                <Card className='bece-card' elevation={5}>
                        <Box component='form' noValidate autoComplete='off' className='bece-form-left'>
                                ...
                                <div className="headbutton">
                                    <button id="newbutt1" name="new" onClick={handleclickables}>New</button>
                                    <button id="newbutt2" name="update" onClick={handleclickables}>Update</button>
                                </div>
                                ...
                                {statuss ?     
                                    <div>
                                        ...
                                        <div style={{ marginTop: '3rem'}}>
                                            ...
                                            email === '' ||
                                            phone === '' ||
                                            candidate === '' ? <Button color='success' 
                                            variant='contained' 
                        ...
                        <Box compnent='div' className='bece-form-right'>
                            ...
                            variant='h4' 
                            align='center' 
                            sx={{ color: 'white', paddingTop: '5rem', fontWeight: 'bold'}}
                            >
                                B.E.C.E
                            </Typography>
